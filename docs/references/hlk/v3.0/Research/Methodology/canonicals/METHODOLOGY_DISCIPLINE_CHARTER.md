...
- **KM Officer** (primary) — owns methodology-pillar curation + technique catalog completeness.
- **Research Analyst** (primary) — applies methodology in per-engagement work; surfaces drift between methodology and engagement reality.
...
- Tier 1 WIP: [`docs/wip/intelligence/`](../../../../../../wip/intelligence/) — methodology drafts staged here before promotion.
- Sister disciplines: Intelligence (collection), Diagnosis (assessment), Validation (truth gates).
