...
[`DATAOPS_DISCIPLINE.md`](../../../../People/canonicals/DATAOPS_DISCIPLINE.md).
...
|:---|:---|
| Canonical CSVs under `People/Compliance/canonicals/` | One-off scripts under `scripts/legacy/` |
...
|:---|:---|:---|
| AC-HUMAN | System Owner or Data Governance Lead walks DATA-01..07 for the touched surface | N/A |
