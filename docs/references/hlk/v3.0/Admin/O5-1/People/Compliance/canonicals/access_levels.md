...
| 4 | Confidential | Requires proper clearance; used for sensitive operations. Management-level access for area leads and department heads. | PMO, Social Media Manager, Organisation, Talent, Business Controller, Financial Controller, Data Scientist, Holistik Researcher, Compliance, SMO, Brand Manager, DevOPS, System Owner, Data Architect, AI Engineer, Tech Lead, Data Governance Office, Growth Manager, Legal Counsel, Intelligence Analyst |
