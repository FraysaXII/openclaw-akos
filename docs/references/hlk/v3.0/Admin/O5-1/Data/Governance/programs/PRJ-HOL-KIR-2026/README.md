...
**Owner role**: Data Governance Office (CDO chain)  
...
> **Process-list anchors** — `thi_data_dtp_274 KiRBe Ingestion Data Quality Monitoring` (Data Governance Office + Data Steward) and `thi_data_dtp_275 Formal Data Lineage` (CDO chain). Both are required for KiRBe to be a reliable KM source.
