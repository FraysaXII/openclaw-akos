...
| **Procesos gobernados** | **1.143** | `py scripts/sync_compliance_mirrors_from_csv.py --count-only` reporta `process_list_rows=1143` (Initiative 49: +7 filas MADEIRA quality / verdict / lifecycle management; Initiative 63 P4: +3 filas blessing/drift/schema-propagation, role_owner=DevOPS/System Owner; Initiative 66: +22 filas brand canon + IntelligenceOps + Engagement Operations + Trademark Naming Governance; Initiative 70 P8 §8.14: +10 filas Marketing M3 sub-area roles, ~20 filas re-asignadas tras hard-remove de Growth Manager + Social Media Manager; Initiative 70 P8 §8.15: +6 filas People sub-area procesos + 2 filas nuevos workstreams Ethics Posture + Learning Curriculum tras hard-remove de Talent + Ethics & Learning monolith per D-IH-70-Q) |
| **Roles definidos** | **75** | `py scripts/sync_compliance_mirrors_from_csv.py --count-only` reporta `baseline_organisation_rows=75` (P13.4 D-W13-E: +1 fila `Holistik Researcher Trainee` bajo `Holistik Researcher`, access_level=2, rate 25/35/50; Initiative 70 P8 §8.14 D-IH-70-T + D-IH-70-Z: +10 filas Marketing M3 sub-area leads y especialistas, -2 filas Growth Manager + Social Media Manager hard-removidas; columnas `sub_area` + `status` añadidas al esquema canonico; Initiative 70 P8 §8.15 D-IH-70-Q: +3 filas Ethics Advisor + Learning Curator + People Operations Manager, -2 filas Talent + Ethics & Learning monolith hard-removidas, sub_area populado para roles de área People) |
