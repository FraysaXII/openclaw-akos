...
| ref_id | class | lens | sensitivity | program_id | open_questions | notes |
|:-------|:------|:-----|:------------|:-----------|:--------------:|:------|
| `GOI-ADV-ENTITY-2026` | `external_adviser` | `entity_readiness` | `internal` | `PRJ-HOL-FOUNDING-2026` | 10 | Seed row from PMO hub stakeholder index. Real firm name kept off-repo per redaction SOP. |
| `GOI-BNK-INC-2026` | `banking_channel` | `incorporation` | `confidential` | `PRJ-HOL-FOUNDING-2026` | 1 | Seed row from PMO hub stakeholder index. Real bank name kept off-repo. |
| `POI-ADV-INTAKE-LEAD-2026` | `external_adviser` | `entity_readiness` | `internal` | `PRJ-HOL-FOUNDING-2026` | 0 | Pre-kick-off intake-stage contact at adviser firm. Operator-managed identity mapping kept off-repo. |
| `POI-BNK-DESK-LEAD-2026` | `banking_channel` | `incorporation` | `confidential` | `PRJ-HOL-FOUNDING-2026` | 1 | Operator-managed identity mapping kept off-repo. |
| `POI-LEG-ENISA-LEAD-2026` | `external_adviser` | `entity_readiness` | `internal` | `PRJ-HOL-FOUNDING-2026` | 4 | Operator-managed identity mapping kept off-repo. |
| `POI-LEG-FISCAL-LEAD-2026` | `external_adviser` | `fiscal_readiness` | `internal` | `PRJ-HOL-FOUNDING-2026` | 2 | Operator-managed identity mapping kept off-repo. |

**Source counts:** 6 GOI/POI rows; 12 programs; 12 open questions.
<!-- END_AUTOGEN section_id=pmo_stakeholder_index_v1 sha256=7b334a843fbc773ca74da8c4cd3236303d62929262f5ea055ab71fdc82a059be -->
