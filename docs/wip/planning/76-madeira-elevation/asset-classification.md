...
| MADEIRA_AIC_PER_TASK_REGISTRY.csv (P4) | canonical | `docs/references/hlk/v3.0/Admin/O5-1/People/Compliance/canonicals/dimensions/` | **Exists** (minted I82 P4, `D-IH-82-S`, per PRECEDENCE line 99); Pydantic `akos/hlk_madeira_aic_per_task_csv.py` + validator `scripts/validate_madeira_aic_per_task.py`. | Same. |
