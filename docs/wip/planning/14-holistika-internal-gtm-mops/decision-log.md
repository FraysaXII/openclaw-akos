...
| D-GTM-3-1 | Supabase DDL (mirrors, `holistika_ops`, deprecations) | Approve written `reports/sql-proposal-*.md` then apply via migrations | **Files committed** — [`scripts/sql/i14_phase3_staging/`](../../../../scripts/sql/i14_phase3_staging/README.md); **staging/prod execute** still operator-gated | blocked |
