...
| **P3 (=E.1)** | **HCAM doctrine home (Data, federated)** | publish HCAM as a **Data-Architecture canonical** (sibling to `SEMANTIC_LAYER.md`); stand up the **Semantic Council** (CDO chair + 1 rep/area); federated area-authorship model; cursor rule + skill. *No new role* (uses Data Architect / Data Governance Lead / Data Steward / AI Engineer). Couple with **I91**. | D-IH-95-E (ownership ratify) |
