...
### §11.4 I73 — People Operations + Learning curriculum (CANDIDATE)

| Field | Value |
|:---|:---|
| State | **candidate** per [`docs/wip/planning/_candidates/i73-people-operations-and-learning-curriculum.md`](../_candidates/i73-people-operations-and-learning-curriculum.md). No INIT row yet. |
| Hold-gates per candidate §6 | (1) I70 closing UAT — **MET** 2026-05-13. (2) I71 P0 charter — **MET** (I71 fully closed 2026-05-14). (3) I72 P0 charter — **MET** (I72 fully closed 2026-05-14). (4) First Holistik Researcher hired (or hiring window committed) — **PENDING**. (5) Founder approval to formally onboard People Operations Lead — **PENDING**. |
| Scope summary | I70 P8.3 split People into 4 sub-disciplines (Compliance + Ethics + Learning + People Operations) but only Compliance has discipline content today. I73 authors the Learning charter + Holistik Researcher onboarding curriculum (Strand A), operationalises Ethics+Learning quarterly co-review (Strand B), mints 4 People Operations SOPs (Strand C), and ratifies the Compliance/Ethics boundary (Strand D). 6 phases (P0 charter through P6 closing UAT). |
| Conundrums (open at candidate stage) | **C-73-1** cohort size for first Holistik Researcher onboarding (1 vs 2 vs 3+); **C-73-2** curriculum versioning anchor (methodology-anchor vs own cadence — default methodology-anchor per I71 P4); **C-73-3** Ethics+Learning review owner (Ethics-leads vs balanced co-ownership); **C-73-4** payroll SOP scope (pure ops vs include benefits/tax); **C-73-5** Compliance/Ethics boundary edge cases (AI-content-disclosure ownership). |
| Cross-link surfaces | [`baseline_organisation.csv`](../../../references/hlk/v3.0/Admin/O5-1/People/Compliance/canonicals/baseline_organisation.csv) People area (4 sub-discipline rows landed at I70 P8.3); [`process_list.csv`](../../../references/hlk/v3.0/Admin/O5-1/People/Compliance/canonicals/process_list.csv) `tbi_peopl_*` rows (orphan reassignments at P4); [`ETHICAL_AUTOMATION_POSTURE.md`](../../../references/hlk/v3.0/Admin/O5-1/People/Ethics/canonicals/ETHICAL_AUTOMATION_POSTURE.md) §5 quarterly review cadence (Strand B anchor); [`FINOPS_COUNTERPARTY_REGISTER.csv`](../../../references/hlk/v3.0/Admin/O5-1/People/Compliance/canonicals/FINOPS_COUNTERPARTY_REGISTER.csv) (Strand C payroll SOP cross-link); I71 P4 review-stamp dimension (`methodology_version_at_review`). |
| Cursor plan (target) | `~/.cursor/plans/i73_people_operations_and_learning_curriculum_<8hex>.plan.md` (8hex assigned at mint time). |
| Workspace mirror (target) | `docs/wip/planning/73-people-operations-and-learning/master-roadmap.md`. |
