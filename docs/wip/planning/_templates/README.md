...
| **I81** | KB integrity + DQ baseline + Compliance forward-layout reorganisation + full-vault SOP body/addendum retrofit (~40 SOPs; Initiative 22 layout execution; `process_list`×SOP×addendum×pairing×mirrors sweep) | candidate (stub; expanded 2026-05-16) | Operator charter; **`baseline`/process approvals** layout tranches + integrity sign-off priorities | [`docs/wip/planning/_candidates/i81-full-vault-sop-addendum-retrofit.md`](../_candidates/i81-full-vault-sop-addendum-retrofit.md) |
