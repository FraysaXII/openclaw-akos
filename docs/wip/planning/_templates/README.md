...
| **I72** — Marketing Area Governance | candidate | [`i72-kickoff-prompt.md`](i72-kickoff-prompt.md) | **Discovery + Plan-Author + P0 charter** | After I71 P2 ships (Pack A4 unblocks RevOps activation Strand C). |
