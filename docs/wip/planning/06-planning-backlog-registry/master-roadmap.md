...
| REG.009 | active | 05 | [REPOSITORIES_REGISTRY.md](../../../references/hlk/v3.0/Envoy%20Tech%20Lab/Repositories/REPOSITORIES_REGISTRY.md) | **Partial:** `openclaw-akos` + candidate KiRBe URL landed; operator-verify KiRBe SSOT; client-delivery TBD | `py scripts/validate_hlk.py` |
