...
| **R-62-10** | `madeira.holistika.com` URL becomes confusable with the AKOS Madeira agent endpoint | Low | Low | Add subtitle on showcase landing page: "Live demo of the Holística operations console"; future `agent.madeira.holistika.com` if agent gets a public surface | Brand Manager |
