...
| **15** | [`15-hlk-api-lifecycle-governance/`](15-hlk-api-lifecycle-governance/) | open | — | Initiative 15 — HLK API lifecycle governance + component matrix |
...
| **22a** | [`22a-i22-post-closure-followups/`](22a-i22-post-closure-followups/) | **Active (2026-04-29)** — bootstrap for Wave-2 (Initiatives 23-26) | — | Initiative 22a — Post-closure follow-ups + Wave-2 bootstrap |
...
| **52** | [`52-multi-model-judge-and-cost-discipline/`](52-multi-model-judge-and-cost-discipline/) | Execution starting 2026-05-03; depends on I51 closure ✓ (calibrated baseline ... | 2026-05-03 | Initiative 52 — Multi-model LLM-judge live activation + RunPod/Kalavai cost discipline |
<!-- END AUTO -->
