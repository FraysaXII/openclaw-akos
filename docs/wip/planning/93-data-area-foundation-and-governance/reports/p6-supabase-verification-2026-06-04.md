...
**DML: PASS (2026-06-05)** — operator applied `artifacts/ops8615-batches/*.sql` via
`pwsh -File scripts/apply_mirror_batches.ps1 -Preset ops8615` (linked
`supabase db query --linked -f`). Live counts **5 / 9 / 1119 / 1119 / 2**.
...
2. Apply `artifacts/ops8615-batches/*.sql` via **`pwsh -File scripts/apply_mirror_batches.ps1 -Preset ops8615`** (linked CLI; see [`docs/guides/holistika-mirror-dml-apply.md`](../../../../guides/holistika-mirror-dml-apply.md)). **psql** remains valid; Editor OK for 01/02/05 only.
3. Re-check counts:
