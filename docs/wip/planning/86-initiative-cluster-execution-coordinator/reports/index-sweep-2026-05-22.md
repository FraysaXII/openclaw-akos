...
| `IDX-02-PRECEDENCE-CSV-COVERAGE` | `PRECEDENCE.md` | fresh | low | _all 39 CSVs mentioned in PRECEDENCE.md_ |
...
| `IDX-06-ARCHITECTURE-HLK-REGISTRY-COVERAGE` | `ARCHITECTURE.md` | fresh | low | _all 25 dimension CSVs mentioned in ARCHITECTURE.md_ |
