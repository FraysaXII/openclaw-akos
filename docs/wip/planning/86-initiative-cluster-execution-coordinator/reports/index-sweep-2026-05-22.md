...
- **Swept by**: `agent:cli`
- **Total findings**: 8 (fresh=7, drift=0, gap=1, blocked=0, skip=0)
...
| `IDX-06-ARCHITECTURE-HLK-REGISTRY-COVERAGE` | `ARCHITECTURE.md` | gap | low | **drift:** 1/21 dimension CSVs missing from ARCHITECTURE HLK Registry: CAPABILITY_REGISTRY.csv <br>**fix:** append rows to ARCHITECTURE.md HLK Registry table for each missing dimension CSV <br>_manual prose write_ |
