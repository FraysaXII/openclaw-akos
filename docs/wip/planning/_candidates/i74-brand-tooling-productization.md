...
> **Update 2026-05-17 — I84 P4 pre-ratification cascade (D-IH-84-D closed; D-IH-74-D pre-ratified as D3).** I84 P4 ratified **D3 — Hybrid library + agent platform** as the MADEIRA productization shape per [`decision-log.md` D-IH-84-D](../84-substrate-doctrine-and-commercial-readiness/decision-log.md). I74 P0 charter receives this as **D-IH-74-D pre-ratification** — Strand C (`@holistika/madeira-agent`) now has its shape gate closed; Strand C ships as **library for technically-mature customers + hosted agent for less-technical customers** rather than as a forced D1 / D2 single-shape commitment. D3 maps cleanly to BOTH TRIGGER-1 (hosted-agent-when-≥3-external-orgs-request-data-detached) AND TRIGGER-2 (library-when-≥2-external-orgs-request-AKOS-as-library) per [`MADEIRA-AKOS/STATUS.md`](../../references/hlk/v3.0/Admin/O5-1/Envoy%20Tech%20Lab/MADEIRA-AKOS/STATUS.md) §3. **C-74-3 closes; C-74-4 license-separation-enforceability** is informed by I84 P1 Tier-1 WIP [`regulatory-tos-forecast.md`](../../intelligence/substrate-audit-2026-Q2/regulatory-tos-forecast.md) §6 + §7 (Cursor SDK ToS analysis + IP-indemnity carve-out findings — ADVOPS engagement recommended per [`advops-engagement-scoping-2026-05-17.md`](../84-substrate-doctrine-and-commercial-readiness/reports/advops-engagement-scoping-2026-05-17.md) before binding library-license posture). I74 P0 charter is free to focus on **library API surface + hosted-agent runtime architecture** decisions rather than the productization-shape meta-decision.
