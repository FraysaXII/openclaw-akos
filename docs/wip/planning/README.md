...
| **10** | [`madeira-eval-hardening/`](10-madeira-eval-hardening/) | **Closed (2026-04-15):** Madeira Path B+C (sandbox + exec, strip web tools from orch/arch), SOTA prompts/dev-local defaults, eval harness + Langfuse metadata, Windows/Docker operator runway — [`master-roadmap.md`](10-madeira-eval-hardening/master-roadmap.md), [`reports/phase-completion-report.md`](10-madeira-eval-hardening/reports/phase-completion-report.md). |
