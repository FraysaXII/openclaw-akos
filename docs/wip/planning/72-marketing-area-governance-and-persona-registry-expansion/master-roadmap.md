...
| **People / People Operations** | adapter row (status: `active`) for engagement → onboarding handoff; paired SOP `SOP-PEOPLE_ENGAGEMENT_HANDOFF_001.md`. Cross-link to I73 People Operations Manager activation. | event_triggered (fires when engagement signed) |
