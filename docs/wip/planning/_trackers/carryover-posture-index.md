...
| CO-90-001 | scheduled | I90 P4b Preview experiential proof slice | P4a+ singularity tranche committed | Preview env + gateway healthy | 2026-06-21 | System Owner | `docs/wip/planning/90-routing-and-wiring/reports/evidence-class-gate-phase-b-preview-slice-2026-06-14.md` |
