...
Canonical CSV lives under docs/references/hlk/compliance/baseline_organisation.csv.
...
# Keep in sync with docs/references/hlk/compliance/baseline_organisation.csv header row.
#
