...
- **HLK admin smoke UAT** — `docs/uat/hlk_admin_smoke.md` documents automated parity checks (pytest + assemble) that align with Scenario 0 without WebChat or browser automation; live tool-backed steps remain under Prerequisites.
