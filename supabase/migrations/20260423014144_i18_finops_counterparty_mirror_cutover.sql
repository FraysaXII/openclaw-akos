-- Parity: scripts/sql/i18_phase1_staging/20260423_i18_finops_counterparty_mirror_up.sql
-- Ledger version: 20260423014144 (remote schema_migrations; rename if git drifted from Dashboard/MCP apply)
-- Dashboard migration name: i18_finops_counterparty_mirror_cutover (Initiative 18)
-- Initiative 18 — counterparty mirror + vendor mirror cutover + Stripe bridge
