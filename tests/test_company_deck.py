...
def test_slide_11_pillar_1_quotes_governance_metrics():
    ...
    topic_count = _csv_rows("docs/references/hlk/v3.0/Admin/O5-1/People/Compliance/canonicals/dimensions/TOPIC_REGISTRY.csv")
    process_count = _csv_rows("docs/references/hlk/v3.0/Admin/O5-1/People/Compliance/canonicals/process_list.csv")
    role_count = _csv_rows("docs/references/hlk/v3.0/Admin/O5-1/People/Compliance/canonicals/baseline_organisation.csv")
