...
def test_sync_compliance_mirrors_count_only() -> None:
    ...
    # Initiative 32 P2/P3/P4/P7: +4 topic rows (skill_registry, touchpoint_kit_cell_registry, policy_register, repo_health_snapshot).
    assert "topic_registry_rows=27" in r.stdout
