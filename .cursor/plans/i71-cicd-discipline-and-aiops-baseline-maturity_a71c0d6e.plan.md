...
| **D-IH-71-R** | Pack A4 ratification (render-ownership coverage thresholds) — renumbered from prior -Q slot since P4 claimed -Q | pending P5 |
| **D-IH-71-S** | Strand B observability cardinality ratification (P5) — renumbered from prior -R slot | pending P5 |
