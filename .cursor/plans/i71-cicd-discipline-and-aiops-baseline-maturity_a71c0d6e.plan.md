...
| **D-IH-71-S** | Pack A4 ratification (render-ownership coverage thresholds) — renumbered from prior -R slot since P4-followup claimed -R | pending P5 |
| **D-IH-71-T** | Strand B observability cardinality ratification (P5) — renumbered from prior -S slot | pending P5 |
