...
_REGISTRY: tuple[tuple[str, str, str], ...] = (
    ...
    (
        "docs/references/hlk/compliance/baseline_organisation.csv",
        "akos.hlk_baseline_org_csv",
        "BASELINE_ORGANISATION_FIELDNAMES",
    ),
    (
        "docs/references/hlk/compliance/FINOPS_COUNTERPARTY_REGISTER.csv",
        "akos.hlk_finops_counterparty_csv",
        "FINOPS_COUNTERPARTY_REGISTER_FIELDNAMES",
    ),
    (
        "docs/references/hlk/compliance/dimensions/GOI_POI_REGISTER.csv",
        "akos.hlk_goipoi_csv",
    ...
    (
        "docs/references/hlk/compliance/dimensions/PERSONA_REGISTRY.csv",
    ...
    (
        "docs/references/hlk/compliance/dimensions/CHANNEL_TOUCHPOINT_REGISTRY.csv",
        "akos.hlk_channel_touchpoint_registry_csv",
        "CHANNEL_TOUCHPOINT_REGISTRY_FIELDNAMES",
    ),
    (
        "docs/references/hlk/compliance/dimensions/SOURCING_REGISTER.csv",
    ...
    (
        "docs/references/hlk/compliance/dimensions/TOUCHPOINT_KIT_CELL_REGISTRY.csv",
    ...
    (
        "docs/references/hlk/compliance/REPO_HEALTH_SNAPSHOT.csv",
        "akos.hlk_repo_health_csv",
        "REPO_HEALTH_SNAPSHOT_FIELDNAMES",
    ),
    (
        "docs/references/hlk/compliance/REPOSITORY_REGISTRY.csv",
        "akos.hlk_repository_registry_csv",
        "REPOSITORY_REGISTRY_FIELDNAMES",
    ),
    (
        "docs/references/hlk/compliance/INITIATIVE_REGISTRY.csv",
        "akos.hlk_initiative_registry_csv",
        "INITIATIVE_REGISTRY_FIELDNAMES",
    ),
    (
        "docs/references/hlk/compliance/OPS_REGISTER.csv",
        "akos.hlk_ops_register_csv",
        "OPS_REGISTER_FIELDNAMES",
    ),
    (
        "docs/references/hlk/compliance/CYCLE_REGISTER.csv",
