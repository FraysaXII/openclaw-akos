...
**Governance:** CSV SSOT is [`FINOPS_COUNTERPARTY_REGISTER.csv`](../../../../docs/references/hlk/v3.0/Admin/O5-1/People/Compliance/canonicals/FINOPS_COUNTERPARTY_REGISTER.csv). DML upserts stay out of migrations—use `py scripts/verify.py compliance_mirror_emit`.
