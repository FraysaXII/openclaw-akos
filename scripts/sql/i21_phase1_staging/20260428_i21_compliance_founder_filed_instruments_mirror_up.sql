-- Initiative 21 — compliance.founder_filed_instruments_mirror (STAGING)
-- Parity: supabase/migrations/*_i21_compliance_founder_filed_instruments_mirror.sql
-- CSV SSOT: docs/references/hlk/compliance/FOUNDER_FILED_INSTRUMENTS.csv
