-- Initiative 21 — compliance.adviser_engagement_disciplines_mirror (STAGING)
-- Parity: supabase/migrations/*_i21_compliance_adviser_disciplines_mirror.sql
-- CSV SSOT: docs/references/hlk/compliance/ADVISER_ENGAGEMENT_DISCIPLINES.csv
