...
_FINOPS_NEW = CANONICALS_DIR / "finops" / "FINOPS_COUNTERPARTY_REGISTER.csv"
_FINOPS_LEGACY = CANONICALS_DIR / "FINOPS_COUNTERPARTY_REGISTER.csv"
FINOPS_COUNTERPARTY_REGISTER_CSV = _FINOPS_NEW if _FINOPS_NEW.is_file() else _FINOPS_LEGACY
...
_ADVISER_DISCIPLINES_NEW = CANONICALS_DIR / "advops" / "ADVISER_ENGAGEMENT_DISCIPLINES.csv"
_ADVISER_DISCIPLINES_LEGACY = CANONICALS_DIR / "ADVISER_ENGAGEMENT_DISCIPLINES.csv"
ADVISER_ENGAGEMENT_DISCIPLINES_CSV = _ADVISER_DISCIPLINES_NEW if _ADVISER_DISCIPLINES_NEW.is_file() else _ADVISER_DISCIPLINES_LEGACY
